...
case class WindowTopKFilterExecTransformer(k: Int,
  ...
  @transient override lazy val metrics =
    BackendsApiManager.getMetricsApiInstance.genWindowTopKFilterTransformerMetrics(sparkContext)

  override def metricsUpdater(): MetricsUpdater =
    BackendsApiManager.getMetricsApiInstance.genWindowTopKFilterTransformerMetricsUpdater(metrics)
  ...
  def getRelNode(context: SubstraitContext,
    ...
    if (!validation) {
      RelBuilder.makeWindowTopKFilterRel(
        input,
        k,
  ...
  override def doValidateInternal(): Boolean = {
    ...
    val relNode = try {
      getRelNode(substraitContext, k, partitionSpec, orderSpec,
  ...
  override def doTransform(context: SubstraitContext): TransformContext = {
    ...
    assert(currRel != null, "WindowTopKFilter Rel should be valid")
  ...
  WindowTopKFilterExecTransformer = copy(child = newChild)
}
